package com.weilongzhang.coder.animation.paint;
...
/**
 * Created by weilongzhang on 16/4/20.
 */
public class PathEffectView extends View {
    ...
    private void init() {
        ...
        // 初始化7个颜色
        colors = new int[] { Color.RED, Color.BLUE, Color.GREEN,Color.RED, Color.BLACK, Color.MAGENTA, Color.CYAN };
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        effects[4] = new PathDashPathEffect(p, 12, phase,PathDashPathEffect.Style.ROTATE);             //PathDashPathEffect
